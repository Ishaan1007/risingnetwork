-- Notifications schema for OneSignal integration
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  type text NOT NULL CHECK (type IN ('team_invitation', 'meeting_reminder', 'connection_request', 'team_update', 'meeting_update')),
  title text NOT NULL,
  body text NOT NULL,
  data jsonb,
